...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(DoorPingException.class)
    public ResponseEntity<ExceptionResponse> handleDoorPingException(DoorPingException ex, WebRequest request) {
        ExceptionResponse response = new ExceptionResponse(
                LocalDateTime.now(),
    ...
    @ExceptionHandler(DoorOpenException.class)
    public ResponseEntity<ExceptionResponse> handleDoorOpenException(DoorOpenException ex, WebRequest request) {
        ExceptionResponse response = new ExceptionResponse(
                LocalDateTime.now(),
                HttpStatus.INTERNAL_SERVER_ERROR.value(),
                "Door Open Error",
    ...
    public ResponseEntity<ExceptionResponse> handleRoutingException(RoutingException ex, WebRequest request) {
        ExceptionResponse response = new ExceptionResponse(
                LocalDateTime.now(),
                HttpStatus.INTERNAL_SERVER_ERROR.value(),
                "Routing Error",
    ...
    public ResponseEntity<ExceptionResponse> handleUserDeletionException(UserDeletionException ex, WebRequest request) {
        ExceptionResponse response = new ExceptionResponse(
                LocalDateTime.now(),
